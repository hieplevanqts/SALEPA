...
export function OnboardingScreen({ onComplete }: OnboardingScreenProps) {
  ...
  const steps = [
    ...
    {
      icon: Calendar,
      title: language === 'vi' ? 'Lịch hẹn thông minh' : 'Smart Appointments',
      description: language === 'vi'
        ? 'Quản lý lịch hẹn cho khách hàng và nhân viên. Thông báo nhắc nhở tự động.'
        : 'Manage appointments for customers and staff. Automatic reminder notifications.',
