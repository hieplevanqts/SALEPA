              ...
              <>
                ...
                <div className="bg-white rounded-2xl border-2 border-gray-200 p-6">
                  <h3 className="text-base font-bold text-gray-900 flex items-center gap-2 mb-4">
                    ...
                    {t.customerData?.contactInfo || 'Thông tin khách hàng'}
                  </h3>
                ...
                <div className="bg-white rounded-2xl border-2 border-gray-200 p-6">
                  <h3 className="text-base font-bold text-gray-900 flex items-center gap-2 mb-4">
                    ...
                    {t.customerData?.additionalInfo || 'Thông tin bổ sung'}
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-xl p-4">
                      <div className="text-sm text-gray-600 mb-1">{t.customerData?.memberSince || 'Thành viên từ'}</div>
                      <div className="font-semibold text-gray-900 text-base">{formatDate(customer.createdAt)}</div>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-4">
                      <div className="text-sm text-gray-600 mb-1">{t.customerData?.lastVisit || 'Lần cuối'}</div>
