...
import type { Order, SelfServiceOrder } from '../../../../lib/fashion-shop-lib/store';
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {(item.variantTitle || item.variantCode) && (
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                          {item.variantTitle && (
                            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-sm font-medium" style={{ backgroundColor: '#FFF7ED', color: '#FE7410' }}>
                              {item.variantTitle}
                            </span>
                          )}
                          {item.variantCode && (
                      ...
                      <div className="text-sm text-gray-500 mb-2">
                        {item.category} {item.barcode && `• Barcode: ${item.barcode}`}
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-lg font-bold text-gray-900">
                          {(item.quantity * ((item.variantPrice !== undefined ? item.variantPrice : item.price) || 0)).toLocaleString()}đ
                        </div>
                      </div>
                    </div>
                  </div>
