...
import { systemPermissions, defaultRoleGroups } from '../../../../lib/fashion-shop-lib/permissionData';
          ...
          <DialogHeader>
            <DialogTitle style={{ fontSize: '20px' }}>
              {editingRole
                ...
                : language === 'vi' ? 'Thêm nhóm quyn mới' : 'Add New Role Group'}
            </DialogTitle>
            <DialogDescription style={{ fontSize: '14px' }}>
              {language === 'vi'
                ? 'Nhập thông tin và chọn các quyền cho nhóm quyền'
