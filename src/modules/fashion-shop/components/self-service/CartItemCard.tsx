...
import type { CartItem } from '../../../../lib/fashion-shop-lib/store';
...
export function CartItemCard({ item, onUpdateQuantity, onUpdateNote, onRemove, compact = false }: CartItemCardProps) {
  ...
  return (
    <div className={`bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 hover:border-blue-300 transition-all ${compact ? 'p-2' : 'p-3'}`}>
