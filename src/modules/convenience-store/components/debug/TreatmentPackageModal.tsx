...
import type { CustomerTreatmentPackage } from '../../../../lib/convenience-store-lib/store';
import { loadDemoPackagesV2 } from '../../../../lib/convenience-store-lib/demoPackagesV2';
        ...
        <div className="px-6 py-4 border-t">
          {totalSelectedSessions > 0 && (
            <button
              ...
              className="w-full px-4 py-2 bg-[#FE7410] text-white rounded-lg hover:bg-[#E56509] transition-colors font-medium mb-4"
            >
