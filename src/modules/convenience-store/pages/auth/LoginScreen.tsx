        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="flex border-b border-gray-200">
            <button
              ...
              className={`flex-1 py-4 text-center text-[16px] font-medium transition-colors relative ${activeTab === 'login'
                ? 'text-[#FE7410]'
            ...
            <button
              ...
              className={`flex-1 py-4 text-center text-[16px] font-medium transition-colors relative ${activeTab === 'register'
                ? 'text-[#FE7410]'
                : 'text-gray-500 hover:text-gray-700'
                }`}
            >
